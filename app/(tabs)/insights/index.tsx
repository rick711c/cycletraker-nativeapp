...
import { chartColors, cyclePhaseColors } from "@/src/theme/muiTheme";
  ...
  const insights = useMemo(() => {
    ...
    const avgCycleLength =
      completedCycles.length > 0
        ? Math.round(
            completedCycles.reduce((sum, c) => sum + (c.length || 0), 0) /
  ...
  return (
    ...
    >
      ...
      <View style={styles.statsGrid}>
        {statCards.map((stat) => (
          <Card key={stat.label} style={styles.statCard} onPress={stat.onPress}>
          ...
          {insights.totalLogs > 0 ? (
            <View style={styles.patternsList}>
              ...
              >
                ...
                >
                  {Math.max(0, stats.averageCycleLength - stats.dayInCycle)}{" "}
                  days
                </Text>
              </View>
            </View>
      ...
      >
        <Card.Content>
          ...
          <Text
            ...
            style={{ color: theme.colors.onSurfaceVariant }}
          >
            Tracking your cycle consistently helps identify patterns and
            potential health issues early. Try to log at least your period dates
            and major symptoms for the most accurate insights.
          </Text>
        </Card.Content>
      </Card>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  statValue: { fontWeight: "700", fontSize: 20, marginBottom: 4 },
  sectionCard: { marginBottom: 16, borderRadius: 16, elevation: 0 },
  ...
  patternValue: { fontWeight: "500", textTransform: "capitalize" },
  emptyStateText: { textAlign: "center", paddingVertical: 32 },
});
